...
//            Logger.getLogger(Product.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void tambahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tambahActionPerformed
        ...
        Statement st = conn1.createStatement();
        String sqlIncrement = "select CUSTOMER_ID from CUSTOMERS where CUSTOMER_ID = (select max(CUSTOMER_ID) from CUSTOMERS)";
        ResultSet rs = st.executeQuery(sqlIncrement);
        while (rs.next()) {
            int tempIncrement = rs.getInt("CUSTOMER_ID");
            int increment = tempIncrement + 1;
            k.customerID.setText(String.valueOf(increment));
