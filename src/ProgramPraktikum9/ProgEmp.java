...
//            Statement st = new conn1.createStatement();
//            rs=st.executeQuery("select region from employees join ");
            if (baris != -1) {
...
//            Logger.getLogger(ProgEmp.class.getName()).log(Level.SEVERE, null, ex);
//        }
        ...
        try {
            ...
            if (conn1 != null) {
                ...
                while (rs.next()) {
                    ...
                    dtm.addRow(new Object[]{id, first_name, last_name, email, phone, date, salary, job});
                }
