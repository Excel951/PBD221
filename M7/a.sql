...
DECLARE
    ...
    CURSOR BATAS2 IS
        ...
        GROUP BY o.ORDER_DATE , p.PRODUCT_NAME , p.LIST_PRICE , i.QUANTITY , oi.QUANTITY ,
                    p.PRODUCT_ID , W.WAREHOUSE_NAME , i.WAREHOUSE_ID , o.ORDER_ID
        ORDER BY o.ORDER_DATE;
...
BEGIN
    ...
    FOR OUTPUT1 IN BATAS1 LOOP
        ...
        IF ABS(QTYTOTAL)-QTYTOTAL = 0 THEN
            DBMS_OUTPUT.PUT_LINE(OUTPUT1."NAMA PRODUK"||' dengan ID: '||OUTPUT1."ID PRODUK"||' tersisa '||ABS(QTYTOTAL));
        ELSE
            DBMS_OUTPUT.PUT_LINE(OUTPUT1."NAMA PRODUK"||' dengan ID: '||OUTPUT1."ID PRODUK"||' kurang '||ABS(QTYTOTAL));
