...
DECLARE
    CURSOR BATAS IS
        ...
        GROUP BY o.ORDER_DATE , p.PRODUCT_NAME , p.LIST_PRICE , i.QUANTITY , o.STATUS , p.PRODUCT_ID , o.ORDER_ID , W.WAREHOUSE_NAME
...
BEGIN
    ...
    FOR OUTPUT IN BATAS LOOP
        ...
        DBMS_OUTPUT.PUT_LINE(' ');
        DBMS_OUTPUT.PUT_LINE('GUDANG: '||OUTPUT.GUDANG);
        DBMS_OUTPUT.PUT_LINE(' ');
